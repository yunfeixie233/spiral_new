...
class SelfPlayArgs(PPOArgs):
    ...
    eval_only: bool = False  # Run evaluation only, skip training
...
if __name__ == "__main__":
    ...
    # Validate that --debug and --eval_only cannot be set together
    assert not (args.debug and args.eval_only), \
        "--debug and --eval_only cannot be set at the same time (--debug skips evaluation)"
